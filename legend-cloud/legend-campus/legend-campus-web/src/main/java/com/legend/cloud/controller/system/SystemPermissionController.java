...
public class SystemPermissionController extends LegendController {
    ...
    public Ajax list(SystemPermissionVO systemPermissionVO, Query query) {
        try {
            ...
            PageUtils pageUtils = new PageUtils(systemPermissionVOList, systemPermissionVOList.size(), query.getCurrentPage(), query.getPageSize());
