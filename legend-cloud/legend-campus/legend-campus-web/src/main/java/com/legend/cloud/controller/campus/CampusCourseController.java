...
public class CampusCourseController extends LegendController {
    ...
    // @RequiresPermissions("campus:campuscourse:list")
    ...
    // @RequiresPermissions("campus:campuscourse:details")
    ...
    // @RequiresPermissions("campus:campuscourse:add")
    ...
    // @RequiresPermissions("campus:campuscourse:update")
    ...
    // @RequiresPermissions("campus:campuscourse:delete")
